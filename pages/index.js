      ...
      >
        ...
        <motion.section variants={fadeInUp} id={"intro"} ref={InfoRef}>
          <div>
            <h3>
              <span>
                <ArrowRightIcon /> Wicked problems are complex, multifaceted,
                jumbled, nuanced, systemic challenges to value-creation. They
                exist in at scales; both large and small.
              </span>
            </h3>
            &nbsp;&nbsp;
            <h3>
              Innovation is a way of being and creating. It&apos;s about
              philosophy working through purpose-built systems to changing the
              way we think and behave.
            </h3>
            &nbsp;&nbsp;
            <h3>
              My approach to innovation is cultivated through the deliberate
              integration of disciplines—engineering, design, cognitive science,
              philosophy, and experimentation—to detangle, make sense of, and
              solve problems from both ends; individual and systemic.
            </h3>
            &nbsp;&nbsp;
            <h3>
              Your tools, tech, and systems should be designed to solve problems
              at scale, for tomorrow not just today.
            </h3>
            &nbsp;&nbsp;
            <h3>
              <span>
                Let&apos;s get creating your future. <RocketIcon />
              </span>
            </h3>
          </div>
        </motion.section>
